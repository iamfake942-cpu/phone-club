...
```
cd existing_repo
git remote add origin https://gitlab.com/mshubham042/phoneclub.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/mshubham042/phoneclub/-/settings/integrations)
